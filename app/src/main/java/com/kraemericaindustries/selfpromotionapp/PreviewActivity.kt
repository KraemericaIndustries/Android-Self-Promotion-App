...
class PreviewActivity : AppCompatActivity() {
    ...
    private fun displayMessage() {
        ...
        messagePreviewText = """
            ...
            My name is ${message.myDisplayName} and I am ${message.getFullJobDescr()}.
     
            I have a portfolio of apps to demonstrate my technical skills that I can share upon request.  
